        ...
        <div class="row">
            <div class="text-center col-sm-6">
                ...
                <div style='font-size: 14em; '>
                  <button type="button" id="favorite-btn-{{ $profile->user_id}}" class="btn {{ $profile->favorite_profile()->where('user_id', Auth::id())->where('profile_id', $profile->user_id)->first() ? "bg-primary" : "bg-white"}}" 
