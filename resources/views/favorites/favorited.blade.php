            ...
            <div class="row">
                ...
                @foreach($favorites as $favorite)
                    ...
                    <div style='font-size: 14em; '>
                      <button type="button" id="favorite-btn-{{ $favorite->user_id}}" class="btn {{ $favorite->where('user_id', Auth::id())->where('profile_id', $favorite->user_id)->first() ? "bg-primary" : "bg-white"}}" 
